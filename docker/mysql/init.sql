...
CREATE DATABASE IF NOT EXISTS robeurope_staging CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON robeurope_staging.* TO 'robeurope_user'@'%';

            ...
            <div>
                <div className="flex justify-center items-start min-h-screen mt-20 space-x-20">
                    ...
                    <div className="max-w-[720px] mx-auto mb-6">
                        ...
                        <div className="bg-blue-200/30 backdrop-blur-md rounded-2xl p-6 shadow-lg">
                            <div className="flex items-center gap-4 pb-8 mt-2">
                                ...
                                <div className="flex flex-col gap-1 w-full">
                                    <div className="flex justify-between items-center">
                                        <h5 className="text-xl font-semibold text-blue-gray-900">Samuelillo Ponce</h5>
                                    ...
                                    <p className="text-base font-light text-blue-gray-900">{t('feedback.roleSamuel')}</p>
                                </div>
                            </div>
                    ...
                    <div className="max-w-[720px] mx-auto mb-6">
                        ...
                        <div className="bg-blue-200/30 backdrop-blur-md rounded-2xl p-6 shadow-lg">
                            <div className="flex items-center gap-4 pb-8 mt-2">
                                ...
                                <div className="flex flex-col gap-1 w-full">
                                    <div className="flex justify-between items-center">
                                        <h5 className="text-xl font-semibold text-blue-gray-900">Ángel Lallave</h5>
                                        <div className="flex gap-1">
                                            {[...Array(5)].map((_, i) => (
                                                <svg key={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                    className="w-5 h-5 text-yellow-700">

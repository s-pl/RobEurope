            ...
            <Card className="md:col-span-2">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-slate-900 dark:text-slate-100">{team.description || t('myTeam.overview.noDesc')}</p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-mono text-sm bg-slate-100 dark:bg-slate-800 p-1 rounded w-fit">{team.id}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  {members.map((m) => (
                    <div key={m.id} className="flex items-center justify-between py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-slate-900 dark:text-slate-100">{t('myTeam.members.userPrefix')} {m.user_id}</p>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="rounded-lg bg-slate-50 dark:bg-slate-900 p-4 border border-slate-100 dark:border-slate-800 flex items-center justify-between">
                  <div>

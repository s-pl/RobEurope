  ...
  es: {
    translation: {
      ...
      team: {
        ...
        dashboard: {
          title: 'Panel de Competición',
          refresh: 'Actualizar',
          tabOverview: 'Resumen',
          tabStream: 'Stream',
          tabLogs: 'Registros',
          tabStats: 'Estadísticas',
          welcomeTitle: 'Panel de competición',
          welcomeDesc: 'Gestiona tu stream y registros de competición desde aquí.',
          quickActions: 'Acciones rápidas',
          startLiveStream: 'Iniciar stream en vivo',
          addLogEntry: 'Añadir registro',
          statusSummary: 'Resumen',
          logEntries: 'Entradas de registro',
          streamConfigTitle: 'Configurar stream',
          streamConfigDesc: 'Configura y lanza tu stream en vivo para la competición.',
          streamUrl: 'URL del stream',
          streamTitle: 'Título del stream',
          description: 'Descripción',
          startStream: 'Iniciar stream',
          starting: 'Iniciando...',
          streamStarted: 'Stream iniciado correctamente',
          newLogEntry: 'Nueva entrada de registro',
          addLog: 'Añadir',
          errorLoadLogs: 'No se pudieron cargar los registros',
          statsLogs: 'Entradas de registro'
        }
      },
      tour: {
        progress: 'Guía',
    ...
    translation: {
      ...
      team: {
        ...
        dashboard: {
          ...
          tabLogs: 'Logs',
          tabStats: 'Stats',
          welcomeTitle: 'Competition dashboard',
          welcomeDesc: 'Manage your stream and competition logs from here.',
          quickActions: 'Quick actions',
          startLiveStream: 'Start live stream',
          addLogEntry: 'Add log entry',
          statusSummary: 'Summary',
          logEntries: 'Log entries',
          streamConfigTitle: 'Stream configuration',
          streamConfigDesc: 'Set up and launch your live stream for the competition.',
  ...
  de: {
    translation: {
      ...
      team: {
        ...
        dashboard: {
          title: 'Wettkampf-Dashboard',
          refresh: 'Aktualisieren',
          tabOverview: 'Übersicht',
          tabStream: 'Stream',
          tabLogs: 'Protokolle',
          tabStats: 'Statistiken',
          welcomeTitle: 'Wettkampf-Dashboard',
          welcomeDesc: 'Verwalte deinen Stream und die Wettkampfprotokolle von hier aus.',
          quickActions: 'Schnellaktionen',
          startLiveStream: 'Livestream starten',
          addLogEntry: 'Protokolleintrag hinzufügen',
          statusSummary: 'Zusammenfassung',
          logEntries: 'Protokolleinträge',
          streamConfigTitle: 'Stream konfigurieren',
          streamConfigDesc: 'Richte deinen Livestream für den Wettkampf ein und starte ihn.',
          streamUrl: 'Stream-URL',
          ...
          newLogEntry: 'Neuer Protokolleintrag',
          addLog: 'Hinzufügen',
          errorLoadLogs: 'Protokolle konnten nicht geladen werden',
          statsLogs: 'Protokolleinträge'
        }
      },
      tour: {
        progress: 'Anleitung',

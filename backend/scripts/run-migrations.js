...
import * as createTeamMessageReactions from '../migrations/20251201-create-team-message-reactions.js';
...
async function run() {
  try {
    ...
    // Create TeamMessageReactions table
    try {
      await createTeamMessageReactions.up(qi, Sequelize);
      console.log('Created TeamMessageReactions table');
    } catch (e) {
      console.log('Skipping createTeamMessageReactions (probably already exists):', e.message);
    }

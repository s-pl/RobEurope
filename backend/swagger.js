...
const swaggerSpec = {
  ...
  components: {
    ...
    schemas: {
      ...
      Competition: { type: 'object', properties: { id: { type: 'string' }, title: { type: 'string' }, slug: { type: 'string' }, description: { type: 'string' }, status: { type: 'string', enum: ['draft', 'published', 'archived'] }, location: { type: 'string' }, max_teams: { type: 'integer' } } },
      CompetitionCreate: { type: 'object', properties: { title: { type: 'string' }, slug: { type: 'string' }, description: { type: 'string' }, status: { type: 'string' }, location: { type: 'string' }, max_teams: { type: 'integer' } }, required: ['title','slug'] },
